/**
 * This file contains tests for the ConnectionWarning feature.
 *
...
import {
  ...
  messageDataFixtures,
  messageFixtures,
} from './fixtures/connection_warning.fixtures.ts';

describe('ConnectionWarning', () => {
  describe('inheritance', () => {
    const instance = new ConnectionWarning('');
  ...
  describe('(message)', () => {
    it('should create an ConnectionWarning with the provided message', () => {
      messageFixtures.forEach(([message, expected]) => {
        const ex = new ConnectionWarning(message);

        assert(ex instanceof ConnectionWarning);
  ...
  describe('(message, {cause})', () => {
    it('should create an ConnectionWarning with the provided message and cause', () => {
      messageCauseFixtures.forEach(([message, cause, expected]) => {
        const ex = new ConnectionWarning(message, { cause });
  ...
  describe('(message, data)', () => {
    it('should create an ConnectionWarning with the provided message and data', () => {
      messageDataFixtures.forEach(([message, data, expected]) => {
        const ex = new ConnectionWarning(message, data);
  ...
  describe('(message, {cause, ...data})', () => {
    it('should create an ConnectionWarning with the provided message, data, and cause', () => {
